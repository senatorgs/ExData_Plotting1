...
plot(pcdata2$Time1, pcdata2$Voltage, type="l", xlab="datetime", ylab="Voltage")

plot(pcdata2$Time1, pcdata2$Sub_metering_1, type="l", xlab="",ylab="Energy sub metering")
...
plot(pcdata2$Time1, pcdata2$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
